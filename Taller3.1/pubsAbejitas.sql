...
if exists (select * from sysdatabases where name='PubsAbejitas')
begin
  raiserror('Dropping existing PubsAbejitas database ....',0,1)
  DROP database PubsAbejitas
end
GO
...
raiserror('Creating PubsAbejitas database....',0,1)
go
/*
   Use default size with autogrow
*/

CREATE DATABASE PubsAbejitas
GO
...
if db_name() <> 'PubsAbejitas'
   raiserror('Error in InstPubs.SQL, ''USE PubsAbejitas'' failed!  Killing the SPID now.'
            ,22,127) with log
...
BEGIN
  exec sp_dboption 'PubsAbejitas','trunc. log on chkpt.','true'
  exec sp_dboption 'PubsAbejitas','select into/bulkcopy','true'
END
ELSE ALTER DATABASE [PubsAbejitas] SET RECOVERY SIMPLE WITH NO_WAIT
GO
...
'This is sample text data for New Moon Books, publisher 0736 in the PubsAbejitas database. New Moon Books is located in Boston, Massachusetts.
...
'This is sample text data for Binnet & Hardley, publisher 0877 in the PubsAbejitas database. Binnet & Hardley is located in Washington, D.C.
...
'This is sample text data for Algodata Infosystems, publisher 1389 in the PubsAbejitas database. Algodata Infosystems is located in Berkeley, California.
...
'This is sample text data for Five Lakes Publishing, publisher 1622 in the PubsAbejitas database. Five Lakes Publishing is located in Chicago, Illinois.
...
'This is sample text data for Ramona Publishers, publisher 1756 in the PubsAbejitas database. Ramona Publishers is located in Dallas, Texas.')
...
'This is sample text data for GGG&G, publisher 9901 in the PubsAbejitas database. GGG&G is located in M�nchen, Germany.')
...
'This is sample text data for Scootney Books, publisher 9952 in the PubsAbejitas database. Scootney Books is located in New York City, New York.')
...
'This is sample text data for Lucerne Publishing, publisher 9999 in the PubsAbejitas database. Lucerne publishing is located in Paris, France.
