...
enlace de visualizacion del informe: https://024100464b-art.github.io/Grupo-1/Aeroquery/Informe-Aeroquery.pdf
...
## 👀 Vistas Previas de Recursos
Puedes acceder y visualizar directamente los archivos complementarios de la propuesta técnica:
* 📊 **[Ver Infografía Interactiva (infografia.html)](infografia.html)** *(Para visualizarla interactivamente, ábrela de forma local en tu navegador o visualízala a través del enlace de GitHub Pages)*.
* 📕 **[Ver Documento: Innovación y Desarrollo Web con Design Thinking e IA (PDF)](<Innovación y Desarrollo Web con Design Thinking e IA.pdf>)** *(GitHub permite la previsualización directa de este archivo PDF al hacer clic)*.

## 📂 Contenido del Repositorio
Este repositorio contiene los documentos base y scripts de la propuesta del proyecto:
 * 📊 infografia.html: Infografía interactiva y visual que resume los componentes clave y objetivos del sistema.
 * 📕 Innovación y Desarrollo Web con Design Thinking e IA.pdf: Documento metodológico que detalla la aplicación de metodologías ágiles y herramientas de Inteligencia Artificial en el diseño de la arquitectura web.
